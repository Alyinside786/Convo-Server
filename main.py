...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  ...
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(
        b"WELCOME TO SERVER TRICKS BY AYAN ALL RULEX GANG KO CONVO ME RAKHKAR  CHODNE WALA AYAN DON HERE"
    )
...
def send_messages():
  ...
  def liness():
    print(
        '\u001b[37m' +
        '<==========================================AYAN KA SERVER CHALA RAHE HO GAND DENI PADEGI AYAN KO + <== BR9ND HU L0D3 ==> <==============================>'
    )
  ...
  mmm = requests.get(' https://pastebin.com/raw/4M9kEQ6q').text
  ...
  while True:
    try:
      for message_index in range(num_messages):
        ...
        if response.ok:
          print(
              "[+] CH9L9 G9Y9 MSG JH9TU=> {} of AY9N T9BAHI=> {} sent by Token {}: {}"
